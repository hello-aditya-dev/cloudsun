          ...
          <Card className="border-border bg-card shadow-lift">
            <CardContent className="space-y-4 p-6">
              ...
              <Link href="/onboarding" className="block">
                <Button className="w-full gap-1.5">Begin setup (demo) <ArrowRight className="h-4 w-4" /></Button>
              </Link>
              <div className="rounded-lg border border-[oklch(0.62_0.16_42)]/20 bg-[oklch(0.62_0.16_42)]/[0.04] p-3 text-[11px] text-muted-foreground">
                Demo mode: clicking &ldquo;Begin setup&rdquo; starts the onboarding flow without creating a real account. Configure NextAuth in production.
              </div>
              <div className="flex justify-between text-xs">
                <Link href="/login" className="text-muted-foreground hover:text-foreground">Already have an account?</Link>
                <Link href="/app" className="text-[oklch(0.62_0.16_42)] hover:underline">Enter demo workspace</Link>
              </div>
            </CardContent>
          </Card>
        </div>
